...
- The `img/` folder (DEV) is for image files that need to be minimized. The build minifies and moves the image file(s) from `img/` into the main `images/` folder\. Handy to have around.
