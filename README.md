...
- The `img/` folder (DEV) is for image files that need to be minimized. The build minifies and copies any image file(s) from the `img/` directory into the main `images/` folder\. Handy.
